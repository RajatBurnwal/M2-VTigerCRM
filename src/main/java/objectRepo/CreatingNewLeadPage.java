...
public class CreatingNewLeadPage {
	 ...
	 * @param mobile
	 */
	public void createNewLead(String lastName, String company, String leadSource,
	 ...
	 * @param state
	 */
	public void createNewLead(String lastName, String company, String noOfEmployees, String mobile, 
			String email, String city, String country, String state)
	{
		getLastNameTextField().sendKeys(lastName);
		getCompanyTextField().sendKeys(company);
		getNoOfEmployeesTextField().sendKeys(noOfEmployees);
